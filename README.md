...
This repository is currently at Phase 3. In addition to identity/profile, daily
care plans, and today's task instances, it implements manual blood-pressure
quick entry and encrypted blood-pressure record APIs.
...
Phase 3 adds encrypted blood-pressure records using `DATA_ENCRYPTION_KEY_B64`
and idempotent final saves using `clientRequestId`. Local debug identity must
use synthetic values and is rejected in test/production.
